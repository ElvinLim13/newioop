...
namespace Assigment19_3
{
    ...
    {
        // 数据库连接字符串
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\Elvin Lim\OneDrive\文档\IOOC\Assigment19-3\Assigment19-3\Performance.mdf"";Integrated Security=True";
